                ...
                <div className="container mx-auto px-4 py-2">
                    ...
                    <div className="flex flex-wrap">
                        <div className="pr-2 w-1/2 md:w-1/4 mb-4">
                            <img src="./images/hotspot_1.jpg" className="bg-slate-300 flex-shrink-0 bg-cover rounded bg-center h-auto w-full min-h-[150px]" />
                            <p className="font-bold">Black Forest</p>
                            <p>Germany</p>
                        </div>
                        <div className="pl-2 md:pr-2 w-1/2 md:w-1/4 mb-4">
                            <img src="./images/hotspot_2.jpg" className="bg-slate-300 flex-shrink-0 bg-cover rounded bg-center h-auto w-full min-h-[150px]" />
                            <p className="font-bold">Kaksalauttanen Arctic Resort</p>
                            <p>Finland</p>
                        </div>
                        <div className="pr-2 md:pl-2 w-1/2 md:w-1/4 mb-4 ">
                            <img src="./images/hotspot_3.jpg" className="bg-slate-300 flex-shrink-0 bg-cover rounded bg-center h-auto w-full min-h-[150px]" />
                            <p className="font-bold">Explora Patagonia</p>
                            <p>Chile</p>
                        </div>
                        <div className="pl-2 w-1/2 md:w-1/4 mb-4">
                            <img src="./images/hotspot_4.jpg" className="bg-slate-300 flex-shrink-0 bg-cover rounded bg-center h-auto w-full min-h-[150px]" />
                            <p className="font-bold">Kakslauttanen Arctic Resort</p>
                            <p>Finland</p>
                        </div>
                    </div>
                    <div className="btnWrapper flex justify-center">
                        <button className="border-gray-200 border-2 h-14 w-32 rounded-full font-bold text-md">See More</button>
                    </div>
                </div>
            </section>
            <section className="border-b-2">
